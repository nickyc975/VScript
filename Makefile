...
vsc: File.o vslexer.o vsparser.o SymTable.o Value.o printers.o vsc.o
	$(CXX) $(OBJ_DIR)/File.o $(OBJ_DIR)/vslexer.o $(OBJ_DIR)/vsparser.o $(OBJ_DIR)/SymTable.o \
	 $(OBJ_DIR)/Value.o $(OBJ_DIR)/printers.o $(OBJ_DIR)/vsc.o -o $(BIN_DIR)/vsc
...
vsparser.o: Value.o $(SRC_CP_DIR)/vsparser.cpp
...
vsc.o: File.o vslexer.o vsparser.o SymTable.o Value.o printers.o $(SRC_CP_DIR)/vsc.cpp
