...
vsc: File.o vslexer.o vsparser.o SymTable.o Value.o Ident.o printers.o vsc.o
	$(CXX) $(OBJ_DIR)/File.o $(OBJ_DIR)/vslexer.o $(OBJ_DIR)/vsparser.o $(OBJ_DIR)/SymTable.o \
	 $(OBJ_DIR)/Value.o $(OBJ_DIR)/Ident.o $(OBJ_DIR)/printers.o $(OBJ_DIR)/vsc.o -o $(BIN_DIR)/vsc

File.o: $(SRC_UTL_DIR)/File.cpp
	$(CXX) -c $(SRC_UTL_DIR)/File.cpp -o $(OBJ_DIR)/File.o

vslexer.o: File.o Value.o $(SRC_CP_DIR)/vslexer.cpp
	$(CXX) -c $(SRC_CP_DIR)/vslexer.cpp -o $(OBJ_DIR)/vslexer.o

vsparser.o: Value.o Ident.o $(SRC_CP_DIR)/vsparser.cpp
...
Value.o: $(SRC_CP_DIR)/Value.cpp
	$(CXX) -c $(SRC_CP_DIR)/Value.cpp -o $(OBJ_DIR)/Value.o

Ident.o: Value.o $(SRC_CP_DIR)/Ident.cpp
	$(CXX) -c $(SRC_CP_DIR)/Ident.cpp -o $(OBJ_DIR)/Ident.o

vsc.o: File.o vslexer.o vsparser.o SymTable.o Value.o Ident.o printers.o $(SRC_CP_DIR)/vsc.cpp
